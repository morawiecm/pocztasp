...
namespace SIPS
{
    class WykazPAczkiPocztaPDF
    {
        ...
        float kwota, suma;
        int numer_zestawienia, tab_lenght;
        string msg_suma;
        ...
        /// <summary>
        /// wydruk paczek dla listow polskich
        /// </summary>
        ...
        public WykazPAczkiPocztaPDF(string wyk, Connect_Mysql con, string lu, string nu, string ju, int[] tab, int tab_l)
        {
            ...
            { //uruchomienie procesu tworzenia pdfa
              ...
              //  pobierz_numer_zestawienia();
                ...
                p = new Paragraph("PACZEK ZWYKŁYCH I POLECONYCH", FontFactory.GetFont(FontFactory.HELVETICA, BaseFont.CP1250, 10));
                p.Alignment = Element.ALIGN_CENTER;
                doc.Add(p);

                p = new Paragraph("DLA URZĘDU POCZTOWEGO", bold);
                p.Alignment = Element.ALIGN_CENTER;
                doc.Add(p);
                ...
                float[] widths = new float[] { 20f, 80f, 100f, 50f, 40f, 140f, 60f, 40f, 20f };
                ...
                cell = new PdfPCell(new Phrase("Adres (Miejsce przeznaczenia)", FontFactory.GetFont(FontFactory.HELVETICA, BaseFont.CP1250, 7)));
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                table.AddCell(cell);

                cell = new PdfPCell(new Phrase("Wartość (Numer przesyłki)", FontFactory.GetFont(FontFactory.HELVETICA, BaseFont.CP1250, 7)));
                cell.VerticalAlignment = Element.ALIGN_MIDDLE;
                cell.HorizontalAlignment = Element.ALIGN_CENTER;
                table.AddCell(cell);
